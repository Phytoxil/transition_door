...
class WWWFed(QtWidgets.QWidget):
    ...
    def paintEvent(self, event: QPaintEvent):
        ...
        # block
        painter.fillRect(0, self.height()/2, self.width(), self.height()/2, QColor(255, 165, 0))
        painter.setPen(QtGui.QPen(QtGui.QColor(100,100,100), 4)) 
        painter.drawRect(0, self.height()/2, self.width(), self.height()/2)
        
        # nose poke 1
        painter.fillRect(1*self.width()/6, 3*self.height()/4, self.width()/6, self.height(), QColor(100, 100, 100))
        # nose poke 2
        painter.fillRect(4*self.width()/6, 3*self.height()/4, self.width()/6, self.height(), QColor(100, 100, 100))
        # fed area
        
        painter.fillRect(self.width()/2-self.width()/7, 5*self.height()/6, self.width()/3.5, self.height()/6, QColor(50, 200, 50))
        ...
        font.setBold(True)
        painter.setFont( font )
        painter.drawText( QRect( 0,self.height()/2.5,self.width(),self.height()/2) , Qt.AlignCenter, self.name )
...
class WWVisualExperiment(QtWidgets.QWidget):
    ...
    def start(self ):
        ...
        self.block.addWall( WWWall ( WWWallSide.RIGHT, WWWallType.GRID ) )    
        
        block2 = Block( 1,0, self )
        ...
        block3 = WWGate( 2,0, self )
        block3.setName("Gate")
        
        block4 = Block( 3,0, self )    
        ...
        block7 = WWGate( 3,2, self )
        block7.setName("Gate")
        block7.setAngle(90)
        
        block8 = Block( 3,3, self )
        ...
        self.mouse = WWMouse( 0.5,1.8 , self )
        mouse2 = WWMouse( 0.8,2 , self )
        mouse3 = WWMouse( 1,2.5 , self )
    
        self.fed = WWWFed( 3.25, -0.4 , self )
        self.fed2 = WWWFed( 2.6, 1.25 , self )
        self.fed2.setAngle( -90 )
        ...
        self.setWindowTitle( "LMT block - Experiment Monitor" )
