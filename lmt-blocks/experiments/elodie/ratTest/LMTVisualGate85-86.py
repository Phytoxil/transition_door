...
class WBalance(QtWidgets.QWidget):
    ...
    def setMeasures( self, data , mouseValue ):
        ...
        self.balanceAx.set_ylim( MIN_BALANCE_WEIGHT_GRAPH, 800 ) #MAX_BALANCE_WEIGHT_GRAPH )
        self.balanceAx.set_ylabel("weight (g)")
...
if __name__ == '__main__':
    ...
    gate = Gate( 
        ...
        COM_Arduino= "COM86", 
        #COM_RFID = "COM5", 
        name="LMT Block AutoGate 85-86",
        weightFactor = 0.65, # 0.74
    ...
    gate = Gate( 
            ...
            name="rat_gate",
            weightFactor = 2.2,
            mouseAverageWeight = 700, #600, #150, #220, #31
            #lidarPinOrder = ( 1, 0, 3 , 2 )            
            gateMode = GateMode.RAT
             )
    gate.rfidControlEnabled = True
