    ...
    def runLogic(self):
        ...
        def phase3PokeRead( sugarFedRead, socialFedRead , nosePokeDirection ):
            ...
            if sugarFedRead != None:
                ...
                if "In" in sugarFedRead and not nosePokeDirection in sugarFedRead:
                    if self.sugarGate.getOrder() == GateOrder.NO_ORDER and not self.chronoExists( "sugarLightPhase3" ) and not self.chronoExists( "errorSugarChrono" ):
                ...
                # correct nose poke
                if "In" in sugarFedRead and nosePokeDirection in sugarFedRead and not self.chronoExists( "sugarLightPhase3" ):
                    ...
                    if self.sugarGate.getOrder() == GateOrder.NO_ORDER:
                        ...
                        self.resetChrono("sugarLightPhase3")
                        #self.signal()
            ...
            if socialFedRead != None:
                ...
                if "In" in socialFedRead and not nosePokeDirection in socialFedRead:
                    if self.socialGate.getOrder() == GateOrder.NO_ORDER and not self.chronoExists( "socialLightPhase3" ) and not self.chronoExists( "errorSocialChrono" ):
                ...
                # correct nose poke
                if "In" in socialFedRead and nosePokeDirection in socialFedRead and not self.chronoExists( "socialLightPhase3" ):
                    ...
                    if self.socialGate.getOrder() == GateOrder.NO_ORDER:
                        ...
                        self.resetChrono("socialLightPhase3")
                        #self.signal()
        ...
        def nosePokePhase( nosePokeDirection ):
            ...
            if self.getChrono(0) > self.PERIOD_LOG_SECOND:
                ...
                logging.info("Number of nose poke ok/wong : sugar: ( " + str( okSugar ) + ", " + str( wrongSugar ) + " ) -- social : ( " + str( okSocial ) + ", " + str( wrongSocial ) + " ) " )
