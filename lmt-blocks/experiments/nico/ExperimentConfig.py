...
import json
from Trial_DNMTP_old import Trial, TrialHabituation, TrialHabituationLight
import logging
...
class PhaseModel():
    ...
    '''
    def __init__(self, namePhase, numberPhase, trialModel, percentToSucceed, numberOfLastTrialToSucceed,
...
class Phase(PhaseModel):
    ...
    def __init__(self, phaseModel: PhaseModel, namePhase, trialModel, numberPhase, percentToSucceed, numberOfLastTrialToSucceed,
                 delayTrials=None, delaySteps=None, numberOfTrialsPerSession = None, maxSessionTime = None, maxTimeBetweenSteps = None):
        PhaseModel.__init__(self, namePhase, numberPhase, trialModel, percentToSucceed, numberOfLastTrialToSucceed,
