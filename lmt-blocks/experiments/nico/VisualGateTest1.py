...
from PyQt5.Qt import QProgressBar, QLabel, QFrame, QPushButton, QSlider, QListWidget
...
# from blocks.autogate.Parameters import DEFAULT_TORQUE_AND_SPEED_LIMIT,\
#     MAX_BALANCE_WEIGHT_GRAPH, MIN_BALANCE_WEIGHT_GRAPH,\
#     NB_VALUE_TO_COMPUTE_MEAN_WEIGHT
...
if __name__ == '__main__':
    ...
    gate.setSpeedAndTorqueLimits(DEFAULT_TORQUE_AND_SPEED_LIMIT, DEFAULT_TORQUE_AND_SPEED_LIMIT)
