...
from transition_doors.transition_doors import GateWrapper
...
class Experiment():
    ...
    def __init__(self, transition_doors: SingleMouseSas):#gate1: Gate, gate2: Gate ):

        self.transition_doors = transition_doors

        self.gate = cast(GateWrapper, transition_doors.sas_door).gate
        ...
        #  )
        #
        # self.gate.doorB.setLimits( OPENED_DOOR_POSITION_MOUSE, CLOSED_DOOR_POSITION_MOUSE-20 )
...
class WWVisualExperiment(QtWidgets.QWidget):
    ...
    def __init__(self, transition_doors: SingleMouseSas): #gate_1: Gate, gate_2: Gate):
        super().__init__()
        ...
        # gate = cast(GateWrapper, transition_doors.sas_door).gate
        # gate_exit = cast(GateWrapper, transition_doors.sas_exit).gate
    ...
    def start(self ):
        ...
        self.gate = self.experiment.gate
        ...
        block3 = WWGate( 1.6,1, self )
        block3.setName("Gate")
        block3.setAngle(90)
        block3.bindToGate(self.gate)
